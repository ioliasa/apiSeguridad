...
import com.jacaranda.miPrimerApi.security.JwtUtils;
import com.jacaranda.miPrimerApi.security.LoginCredential;
...
public class AuthController {
	...
	public ResponseEntity<?> authenticateUser(@RequestBody LoginCredential loginRequest) {
		...
		//Si el usuario y el password que le paso son los adecuados me devuele un autentication
