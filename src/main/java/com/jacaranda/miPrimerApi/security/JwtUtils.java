...
public class JwtUtils {
		...
		// que quede almacenada en el token, en nuestro caso vamos a guardar el username, el email y el role
	    ...
	    // Obtiene al información del usuario a partir de un token o nulo si el token no es correcto
